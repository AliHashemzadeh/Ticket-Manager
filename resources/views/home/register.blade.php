...
<div class="login-form">
    <form action="" method="post">
        ...
        <div class="form-group">
            <input type="text" name="name" class="form-control" placeholder="نام کامل" value="{{ old('name') }}">
        </div>
        <div class="form-group">
    ...
    <p class="text-center">حساب کاربری دارید ؟ <a href="{{ route('login.view') }}">ورود</a></p>
</div>
</body>
</html>